...
[![Build](https://github.com/zmkfirmware/zmk/workflows/Build/badge.svg)](https://github.com/zmkfirmware/zmk/actions) ⭐ 4,266 | 🐛 427 | 🌐 C | 📅 2026-09-15
...
* [ZMK GitHub Repository](https://github.com/zmkfirmware/zmk) ⭐ 4,266 | 🐛 427 | 🌐 C | 📅 2026-09-15 - The source code and development hub.
...
* [Zephyr Project Code Repository on GitHub](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,538 | 🐛 3,918 | 🌐 C | 📅 2026-09-16 - Primary Git Repository for the Zephyr Project. Zephyr is a new generation, scalable, optimized, secure RTOS for multiple hardware architectures.
...
* [nRF Connect SDK (sdk-nrf)](https://github.com/nrfconnect/sdk-nrf) ⭐ 1,430 | 🐛 255 | 🌐 C | 📅 2026-09-16 - Main nRF Connect SDK repository (west manifest, subsystems, samples).
* [Nordic Developer Academy / Tutorials](https://github.com/NordicDeveloperAcademy/ncs-fund) ⭐ 116 | 🐛 2 | 🌐 C | 📅 2026-09-16 - self-paced courses and examples (useful to onboard newcomers).
...
* [fffaraz/awesome-cpp](https://github.com/fffaraz/awesome-cpp) ⭐ 73,323 | 🐛 310 | 📅 2026-09-05 - A curated list of awesome C++ (or C) frameworks, libraries, resources, and shiny things.
* [veggiemonk/awesome-docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,835 | 🐛 32 | 📅 2026-09-12 - A curated list of Docker resources and related projects about the Docker ecosystem.
* [sdras/awesome-actions](https://github.com/sdras/awesome-actions) ⭐ 28,231 | 🐛 309 | 📅 2024-09-01 - A curated list of awesome things related to GitHub Actions.
* [dictcp/awesome-git](https://github.com/dictcp/awesome-git) ⭐ 2,946 | 🐛 80 | 📅 2026-07-07 - A curated list of amazingly awesome Git tools, resources and shiny things.
* [moul/awesome-ssh](https://github.com/moul/awesome-ssh) ⭐ 2,840 | 🐛 48 | 📅 2023-08-10 - A curated list of SSH apps, libraries and resources.
...
* [caksoylar/keymap-drawer](https://keymap-drawer.streamlit.app/) - Visualize keymaps that use advanced features like hold-taps and combos, with automatic parsing.
  * [caksoylar/keymap-drawer](https://github.com/caksoylar/keymap-drawer) ⭐ 1,329 | 🐛 27 | 🌐 Python | 📅 2026-08-12 - source code on GitHub
...
* [diimdeep/awesome-split-keyboards](https://github.com/diimdeep/awesome-split-keyboards) ⭐ 5,872 | 🐛 36 | 📅 2024-07-06 - A collection of ergonomic split keyboards
...
* [crkbd/reddit.com](https://www.reddit.com/r/crkbd/) - crkbd, a.k.a. Corne Keyboard <https://github.com/foostan/crkbd> ⭐ 7,647 | 🐛 23 | 🌐 Makefile | 📅 2025-05-10 <https://discord.com/invite/aWCZWnS> Created Dec 16, 2019
...
* [nrfconnect/sdk-nrf/../pmw3360](https://github.com/nrfconnect/sdk-nrf/tree/main/drivers/sensor/pmw3360) ⭐ 1,430 | 🐛 255 | 🌐 C | 📅 2026-09-16 - PMW3360 mouse optical sensor
  * [LicenseID:  LicenseRef-Nordic-5-Clause](https://github.com/nrfconnect/sdk-nrf/blob/main/LICENSE) ⭐ 1,430 | 🐛 255 | 🌐 C | 📅 2026-09-16 - Copyright (c) 2018, Nordic Semiconductor ASA
...
[^2]: ZMK Firmware official code repository: <https://github.com/zmkfirmware/zmk> ⭐ 4,266 | 🐛 427 | 🌐 C | 📅 2026-09-15

[^3]: Zephyr Project official website: <https://www.zephyrproject.org>

[^4]: Zephyr Project Code Repository: <https://github.com/zephyrproject-rtos/zephyr> ⭐ 16,538 | 🐛 3,918 | 🌐 C | 📅 2026-09-16
