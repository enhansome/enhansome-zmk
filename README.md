...
[![Build](https://github.com/zmkfirmware/zmk/workflows/Build/badge.svg)](https://github.com/zmkfirmware/zmk/actions) ⭐ 4,243 | 🐛 419 | 🌐 C | 📅 2026-08-28
...
* [ZMK GitHub Repository](https://github.com/zmkfirmware/zmk) ⭐ 4,243 | 🐛 419 | 🌐 C | 📅 2026-08-28 - The source code and development hub.
...
* [Zephyr Project Code Repository on GitHub](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,337 | 🐛 3,856 | 🌐 C | 📅 2026-08-28 - Primary Git Repository for the Zephyr Project. Zephyr is a new generation, scalable, optimized, secure RTOS for multiple hardware architectures.
...
* [fffaraz/awesome-cpp](https://github.com/fffaraz/awesome-cpp) ⭐ 72,981 | 🐛 312 | 📅 2026-08-22 - A curated list of awesome C++ (or C) frameworks, libraries, resources, and shiny things.
* [veggiemonk/awesome-docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,736 | 🐛 26 | 📅 2026-08-27 - A curated list of Docker resources and related projects about the Docker ecosystem.
* [sdras/awesome-actions](https://github.com/sdras/awesome-actions) ⭐ 28,169 | 🐛 278 | 📅 2024-09-01 - A curated list of awesome things related to GitHub Actions.
...
* [moul/awesome-ssh](https://github.com/moul/awesome-ssh) ⭐ 2,835 | 🐛 46 | 📅 2023-08-10 - A curated list of SSH apps, libraries and resources.
...
* [ZMK Studio (Offline via BLE)](https://github.com/zmkfirmware/zmk-studio/releases) ⭐ 314 | 🐛 59 | 🌐 TypeScript | 📅 2026-07-02 - A desktop application that allows you to modify your keymap offline via Bluetooth.
...
* [nickcoutsos/keymap-editor](https://nickcoutsos.github.io/keymap-editor/) - A web based graphical editor of ZMK keymaps.
  * [nickcoutsos/keymap-editor](https://github.com/nickcoutsos/keymap-editor) ⭐ 2,062 | 🐛 66 | 🌐 JavaScript | 📅 2026-08-27 -  source code on GitHub
  * [nickcoutsos/keymap-editor/wiki](https://github.com/nickcoutsos/keymap-editor/wiki) ⭐ 2,062 | 🐛 66 | 🌐 JavaScript | 📅 2026-08-27 - keymap-editor wiki!
...
* [diimdeep/awesome-split-keyboards](https://github.com/diimdeep/awesome-split-keyboards) ⭐ 5,861 | 🐛 36 | 📅 2024-07-06 - A collection of ergonomic split keyboards
...
[^2]: ZMK Firmware official code repository: <https://github.com/zmkfirmware/zmk> ⭐ 4,243 | 🐛 419 | 🌐 C | 📅 2026-08-28

[^3]: Zephyr Project official website: <https://www.zephyrproject.org>

[^4]: Zephyr Project Code Repository: <https://github.com/zephyrproject-rtos/zephyr> ⭐ 16,337 | 🐛 3,856 | 🌐 C | 📅 2026-08-28
